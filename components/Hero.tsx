...
const Hero = () => {
  return (
    <div className="pb-20 pt-36">
      <div className="h-screen top-0 -left-0 w-full dark:bg-transparent  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] absolute flex items-center justify-center">
        {/* <div
        className="h-screen w-screen items-center justify-center bg-transparent
       dark:bg-dot-white/[0.19] bg-dot-black/[0.2] absolute 
       flex  bottom-0 right-0 top-0 -left-0"
      > */}
        <div
